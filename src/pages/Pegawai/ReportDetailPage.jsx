                ...
                <header className="px-4 py-3 bg-white/80 backdrop-blur border-b border-neutral-200 sticky top-0 z-10 print:hidden">
                    <div className="max-w-7xl mx-auto flex justify-between items-center">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 rounded-xl bg-red-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-red-700 active:scale-95"
                        >
                ...
                <main className="max-w-7xl mx-auto p-4 sm:p-6">
                    {isLoading ? <LoadingSpinner /> : error.message ? (
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                            ...
                            {/* Print-only AI Analysis Section */}
